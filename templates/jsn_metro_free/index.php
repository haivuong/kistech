...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		...
		?>
			...
			?>
					<div id="jsn-content-bottom-over" class="jsn-modulescontainer jsn-modulescontainer<?php echo $jsnutils->countModules('content-bottom-over'); ?> row-fluid">
						<div id="jsn-pos-content-bottom-over">
							<jdoc:include type="modules" name="content-bottom-over" style="jsnmodule" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-bottom-over')); ?>" />
							<div class="clearbreak"></div>
						</div>
					</div>
					<div class="clearbreak"></div>
			...
			?>
						<div id="jsn-usermodules3" class="jsn-modulescontainer jsn-modulescontainer<?php echo $grid_suffix; ?> row-fluid">
						<?php
				...
				<div id="jsn-footermodules" class="jsn-modulescontainer jsn-modulescontainer<?php echo $grid_suffix; ?>">
					...
					?>
							<div id="jsn-pos-footer" class="row-fluid">
								<jdoc:include type="modules" name="footer" style="jsnmodule" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('footer')); ?>" />
							</div>
					<?php
						}
					...
					?>
							<div id="jsn-pos-bottom" class="row-fluid">
								<jdoc:include type="modules" name="bottom" style="jsnmodule" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('bottom')); ?>" />
							</div>
					<?php
						}
					?>
